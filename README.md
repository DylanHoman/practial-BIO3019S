...
```
    ...
    ## alpha_Intercept      0.25      0.03     0.19     0.31 1.01     1031     1041
    ## gamma_Intercept      0.32      0.03     0.27     0.38 1.00     1160     1164
    ## lambda_Intercept     1.23      0.28     0.79     1.89 1.00     1367     1486
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.07      0.00     0.07     0.08 1.00     1611     1473
    ## 
...
```
    ...
    ## Regression Coefficients:
    ##                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## alpha_Intercept      0.21      0.03     0.15     0.26 1.00     1061     1205
    ## gamma_Intercept      0.36      0.03     0.32     0.41 1.00     1187     1447
    ## lambda_Intercept     1.03      0.19     0.73     1.46 1.00     1330     1864
    ## A_Intercept          0.06      0.01     0.05     0.08 1.00     2248     1743
    ## phi_Intercept       -0.84      0.12    -1.07    -0.61 1.00     2437     1892
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.06      0.00     0.05     0.07 1.00     2478     1864
    ## 
    ## Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
    ## and Tail_ESS are effective sample size measures, and Rhat is the potential
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
